...
declare function DrawerForm<T = Record<string, any>>({ children, trigger, onVisibleChange, drawerProps, onFinish, submitTimeout, title, width, onOpenChange, visible: propVisible, open: propsOpen, ...rest }: DrawerFormProps<T>): import("react/jsx-runtime").JSX.Element;
export { DrawerForm };
