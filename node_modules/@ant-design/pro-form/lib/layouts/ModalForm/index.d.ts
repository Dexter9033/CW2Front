...
declare function ModalForm<T = Record<string, any>>({ children, trigger, onVisibleChange, onOpenChange, modalProps, onFinish, submitTimeout, title, width, visible: propVisible, open: propsOpen, ...rest }: ModalFormProps<T>): import("react/jsx-runtime").JSX.Element;
export { ModalForm };
